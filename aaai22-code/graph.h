#ifndef FOCTL_GRAPH_H
#define FOCTL_GRAPH_H
...
public:
      ...
      next_vertex_id{other.next_vertex_id}
  {
    ...
    for(auto& e_obj_other : other.edge_obj_collection) {
      ...
      e_obj.orig_vertex.vertex_obj_ptr->outgoing_ev_list.emplace_back(e, e_obj.orig_vertex);
      e_obj.orig_outgoing_ev_itr = e_obj.orig_vertex.vertex_obj_ptr->outgoing_ev_list.end();
      e_obj.orig_outgoing_ev_itr--;
      e_obj.dest_vertex.vertex_obj_ptr->incoming_ev_list.emplace_back(e, e_obj.dest_vertex);
